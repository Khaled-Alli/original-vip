...
class TextStyles {
  ...
  static TextStyle font10whiteBold = TextStyle(fontWeight: FontWeight.bold,fontSize: 10.sp);
  ...
  static TextStyle font18whiteBold = TextStyle(fontWeight: FontWeight.bold,fontSize: 18.sp);
